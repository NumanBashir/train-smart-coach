      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-8 lg:gap-12">
          ...
          <div className="w-full lg:w-1/2 text-center lg:text-left">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold tracking-tight text-gray-900 leading-tight">
              Unlock Your Coaching <br className="hidden sm:block" /> Potential
              with Us
            </h2>
            <p className="mt-3 sm:mt-4 w-full sm:w-3/4 mx-auto lg:mx-0 text-sm sm:text-base lg:text-lg text-gray-600 leading-relaxed">
...
export default ImageHeaderTextBlockRight;
