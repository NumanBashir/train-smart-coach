        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
          <div className="flex flex-col items-center text-center">
            ...
            <h1 className="mt-4 text-xl font-semibold text-gray-800 dark:text-white">
              Tactical Drill Library
            </h1>

            <p className="mt-2 text-gray-500 dark:text-gray-400">
              Instantly access a growing collection of position-specific and
              team-based drills for all age groups. From build-up patterns to
              pressing triggers — all built for modern football
            </p>
          </div>
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <p className="mt-2 text-gray-500 dark:text-gray-400">
              Built for real coaches with real needs. Create, edit, and reuse
              your favorite drills with minimal clicks — so you spend more time
              on the pitch, not the screen.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <p className="mt-2 text-gray-500 dark:text-gray-400">
              Access your sessions on any device and share drill PDFs or links
              with your staff and players. Whether in the locker room or on the
              go — you're always ready
            </p>
          </div>
        </div>
      </div>
